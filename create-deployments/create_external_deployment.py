...
async def main():
    ...
    deployment_conf = [ validate_model_conf(conf) for conf in deployment_conf]                  
    deployment_conf = [ register_dataset(conf) for conf in deployment_conf]
    deployment_conf = [ create_external_model_version(conf) for conf in deployment_conf]
    deployment_conf = [ create_external_deployment(conf) for conf in deployment_conf]
    await asyncio.gather( *[update_deployment_settings(conf, True, True) for conf in deployment_conf])
